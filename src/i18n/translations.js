...
export const translations = {
  en: {
    ...
    philo_principles_aria: "Principles",
    philo_eyebrow: "PHILOSOPHY",
    philo_title: "Restraint is a feature.",
    philo_copy:
      "We build systems with restraint: clear hierarchy, strong defaults, and motion only when it earns its place.",
    philo_tag: "Designed like a product page. Engineered like a system.",

    philo_01_k: "Hierarchy",
    philo_01_v: "Signal first. Detail later.",
    philo_02_k: "Defaults",
    philo_02_v: "Opinionated. Consistent. Reusable.",
    philo_03_k: "Motion",
    philo_03_v: "State + structure. Never decoration.",
    philo_04_k: "Performance",
    philo_04_v: "Budgeted. Measured. Protected.",
